...
with col10:
    ...
    fig.layout.update(yaxis=dict(titlefont=dict(size=14),color = '#FFFFFF', autorange=False, showgrid=False),
                      xaxis=dict(titlefont=dict(size=14), tickformat=',.0f', color = '#FFFFFF', autorange=False, showline=False, showgrid=False),
